...
class ReaderModelsTests(TestCase):
    ...
    def test_subscribe_not_subcribed_yet(self):
        # not subscribed yet
    ...
    def test_is_subscribed_subscribed(self):
        # subscribed
        f, u = self._test_subscribe_setup()
        f.subscribe(u)
        self.assertTrue(f.is_subscribed(u))
...
<feed xmlns="http://www.w3.org/2005/Atom">
    ...
    def test_update_feeds_num_feeds(self):
        ...
        with requests_mock.Mocker() as mock:
            ...
            Feed.update_feeds(1)
            self.assertEqual(1, Feed.objects.exclude(last_checked=None).count())
...
<feed xmlns="http://www.w3.org/2005/Atom">
   ...
   <entry>
    ...
    def test_update_feeds_entry(self):
  ...
  <entry>
    ...
    <author>
       ...
       <email>john@example.com</email
            ...
            e = f.entry_set.first()
            self.assertEqual('John Doe (john@example.com)', e.author)

    def test_updates_feeds_no_summary(self):
  ...
  <entry>
    ...
    <author>
       ...
       <email>john@example.com</email
            ...
            Feed.update_feeds()
            e = f.entry_set.first()
            self.assertEqual('<p>Some text.</p>', e.content)
